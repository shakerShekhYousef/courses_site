...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $homeSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homeSection): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($homeSection->name == \App\Models\HomeSection::$full_advertising_banner and !empty($advertisingBanners1) and count($advertisingBanners1)): ?>
            ...
            <section class="home-sections home-sections-swiper container">
                <h2 class="font-16 font-weight-bold text-secondary"><?php echo e(trans('site.contact_an_expert')); ?></h2>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="subject" class="form-control <?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="project_management_expert" <?php echo e(old('expert') == 'project_management_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.project_management_expert')); ?>

                                    </option>
                                    <option value="psychological_expert" <?php echo e(old('expert') == 'psychological_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.psychological_expert')); ?>

                                    </option>
                                    <option value="language_expert" <?php echo e(old('expert') == 'language_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.language_expert')); ?>

                                    </option>
                                    <option value="tourism_expert" <?php echo e(old('expert') == 'tourism_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.tourism_expert')); ?>

                                    </option>
                                    <option value="energy_spirituality_expert" <?php echo e(old('expert') == 'energy_spirituality_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.energy_spirituality_expert')); ?>

                                    </option>
                                    <option value="emotional_classification_medicine_expert" <?php echo e(old('expert') == 'emotional_classification_medicine_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.emotional_classification_medicine_expert')); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="<?php echo e(trans('site.project_management_expert')); ?>" <?php echo e(old('expert') == 'project_management_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.project_management_expert')); ?>

                                    </option>
                                    <option value="{ trans('site.psychological_expert') }}" <?php echo e(old('expert') == 'psychological_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.psychological_expert')); ?>

                                    </option>
                                    <option value="<?php echo e(trans('site.language_expert')); ?>" <?php echo e(old('expert') == 'language_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.language_expert')); ?>

                                    </option>
                                    <option value="<?php echo e(trans('site.tourism_expert')); ?>" <?php echo e(old('expert') == 'tourism_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.tourism_expert')); ?>

                                    </option>
                                    <option value="<?php echo e(trans('site.energy_spirituality_expert')); ?>" <?php echo e(old('expert') == 'energy_spirituality_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.energy_spirituality_expert')); ?>

                                    </option>
                                    <option value="<?php echo e(trans('site.emotional_classification_medicine_expert')); ?>" <?php echo e(old('expert') == 'emotional_classification_medicine_expert' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('site.emotional_classification_medicine_expert')); ?>
...
<?php echo $__env->make(getTemplate().'.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u514029155/domains/worldgateconsultation.ae/public_html/resources/views/web/default/pages/home.blade.php ENDPATH**/ ?>