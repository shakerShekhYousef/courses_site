    ...
    @foreach($homeSections as $homeSection)
        ...
        @if($homeSection->name == \App\Models\HomeSection::$full_advertising_banner and !empty($advertisingBanners1) and count($advertisingBanners1))
            <div class="home-sections container">
              ...
              {{--contact us --}}
            <section class="home-sections home-sections-swiper container">
                <h2 class="font-16 font-weight-bold text-secondary">{{ trans('site.contact_an_expert') }}</h2>
                        ...
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                ...
                                <select name="subject" class="form-control @error('subject') is-invalid @enderror">
                                    <option value="project_management_expert" {{ old('expert') == 'project_management_expert' ? 'selected' : '' }}>
                                        {{ trans('site.project_management_expert') }}
                                    </option>
                                    <option value="psychological_expert" {{ old('expert') == 'psychological_expert' ? 'selected' : '' }}>
                                        {{ trans('site.psychological_expert') }}
                                    </option>
                                    <option value="language_expert" {{ old('expert') == 'language_expert' ? 'selected' : '' }}>
                                        {{ trans('site.language_expert') }}
                                    </option>
                                    <option value="tourism_expert" {{ old('expert') == 'tourism_expert' ? 'selected' : '' }}>
                                        {{ trans('site.tourism_expert') }}
                                    </option>
                                    <option value="energy_spirituality_expert" {{ old('expert') == 'energy_spirituality_expert' ? 'selected' : '' }}>
                                        {{ trans('site.energy_spirituality_expert') }}
                                    </option>
                                    <option value="emotional_classification_medicine_expert" {{ old('expert') == 'emotional_classification_medicine_expert' ? 'selected' : '' }}>
                                        {{ trans('site.emotional_classification_medicine_expert') }}
                                    </option>
                                </select>
                                @error('subject')
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <div class="form-group">
                                <label class="input-label font-weight-500">{{ trans('site.subject') }}</label>
                                <select name="subject" class="form-control @error('subject') is-invalid @enderror">
                                    <option value="{{ trans('site.project_management_expert') }}" {{ old('expert') == 'project_management_expert' ? 'selected' : '' }}>
                                        {{ trans('site.project_management_expert') }}
                                    </option>
                                    <option value="{ trans('site.psychological_expert') }}" {{ old('expert') == 'psychological_expert' ? 'selected' : '' }}>
                                        {{ trans('site.psychological_expert') }}
                                    </option>
                                    <option value="{{ trans('site.language_expert') }}" {{ old('expert') == 'language_expert' ? 'selected' : '' }}>
                                        {{ trans('site.language_expert') }}
                                    </option>
                                    <option value="{{ trans('site.tourism_expert') }}" {{ old('expert') == 'tourism_expert' ? 'selected' : '' }}>
                                        {{ trans('site.tourism_expert') }}
                                    </option>
                                    <option value="{{ trans('site.energy_spirituality_expert') }}" {{ old('expert') == 'energy_spirituality_expert' ? 'selected' : '' }}>
                                        {{ trans('site.energy_spirituality_expert') }}
                                    </option>
                                    <option value="{{ trans('site.emotional_classification_medicine_expert') }}" {{ old('expert') == 'emotional_classification_medicine_expert' ? 'selected' : '' }}>
                                        {{ trans('site.emotional_classification_medicine_expert') }}
                                    </option>
                                </select>
                                @error('subject')
